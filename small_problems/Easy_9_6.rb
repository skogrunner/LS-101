...
# Return an Array containing every word from the string along with
#   an appended space and the word length.
# All words are separated by one space, and any substring of
